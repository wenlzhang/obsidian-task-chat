    ...
    private static buildTaskFilter(
        intent: {
            ...
            dueDateRange?: {
                ...
                date?: string;
                endDate?: string;
                // LEGACY: start/end format (backward compatibility)
                start?: string;
                end?: string;
            } | null;
        ...
        // Build date range filter (supports operator-based ranges for vague queries)
        if (intent.dueDateRange) {
            ...
            if (intent.dueDateRange.operator && intent.dueDateRange.date) {
                ...
                // LEGACY: start/end format (for backward compatibility)
